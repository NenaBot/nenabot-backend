...
| `NENABOT_REACHABILITY_CHECK`              | `1`                     | Enable the backend/robot reachability guard (`1` = reject out-of-reach waypoints before/during movement, `0` = allow them). Disabling this only bypasses the software guard; hardware/controller movement failures can still fail a job.                                                                                                                                                                                   |
